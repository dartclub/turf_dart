...
Point _$PointFromJson(Map<String, dynamic> json) => Point(
      ...
      coordinates: json['coordinates'] == null
          ? Position(0,0)
          : Position.fromJson((json['coordinates'] as List<dynamic>)
              .map((e) => e as num)
              .toList()),
    );
...
FeatureCollection<T> _$FeatureCollectionFromJson<T extends Geometry>(
    ...
    FeatureCollection<T>(
      ...
      features: ((json['features'] as List<dynamic>?)
              ...
              .toList() ??
          const []) as List<Feature<T>>,
    );

Map<String, dynamic> _$FeatureCollectionToJson<T extends Geometry>(
        FeatureCollection<T> instance) =>
    <String, dynamic>{
