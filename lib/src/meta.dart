...
typedef CoordEachCallback = dynamic Function(
    Position currentCoord, // or List<num>?
    num coordIndex,
    num featureIndex,
    num multiFeatureIndex,
    num geomtgeometryIndex);

/// Iterates over coordinates of any [GeoJSONObject], calling [callback] on each
/// iteration. Similar to [Iterable].forEach()
///
/// Gets [FeatureCollection], [Feature], [GeometryObject] or any [GeoJSONOBject]
