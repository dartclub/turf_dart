...
Position destinationRaw(Position origin, double distance, double bearing,
    [Unit unit = Unit.kilometers]) {
  double longitude1 = degreesToRadians(origin.lng);
  double latitude1 = degreesToRadians(origin.lat);
  double bearingRad = degreesToRadians(bearing);
  double radians = lengthToRadians(distance, unit);
...
Point destination(Point origin, double distance, double bearing,
        [Unit unit = Unit.kilometers]) =>
    Point(
