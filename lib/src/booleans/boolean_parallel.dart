...
bool booleanParallel(GeoJSONObject line1, GeoJSONObject line2) {
  ...
  if (type1 != "LineString") throw Exception("line1 must be a LineString");
  var type2 = getType(line2, "line2");
  if (type2 != "LineString") throw Exception("line2 must be a LineString");
 ...
 */
isParallel(List<Position> segment1, List<Position> segment2) {
 ...
 */
getType(GeoJSONObject geojson, String name) {
