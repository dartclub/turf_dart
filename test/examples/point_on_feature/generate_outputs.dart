...
Future<void> processFile(String filename) async {
  try {
    ...
    if (pointResult != null) {
      ...
      } else if (featureInput is FeatureCollection &&
          featureInput.features.isNotEmpty) {
      ...
      if (inputGeometry != null) {
        ...
        if (inputGeometry is Polygon || inputGeometry is MultiPolygon) {
          ...
          styledInputFeature.properties!['fill-opacity'] = 0.2;
            ...
            inputGeometry is MultiLineString) {
          styledInputFeature.properties!['stroke'] = '#0000FF';
          styledInputFeature.properties!['stroke-width'] = 2;
      ...
      final styledPointResult =
          Feature(geometry: pointResult.geometry, properties: {
        'marker-color': '#FF0000',
        'marker-size': 'medium',
        'marker-symbol': 'star',
      ...
      print(
          '  Found point at coordinates: ${pointResult.geometry?.coordinates}');
    } else {
        ...
        'features': [
          {
            ...
            'properties': {
              ...
              'name': 'Error',
              'description':
                  'pointOnFeature function could not generate a point'
            },
            'geometry': null
          }
        ]
    ...
    await outputFile
        .writeAsString(JsonEncoder.withIndent('  ').convert(outputJson));
