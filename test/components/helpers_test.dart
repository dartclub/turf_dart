...
void main() {
  group('Coordinate System Conversions', () {
    test('convertCoordinates should convert between systems', () {
      final wgs84Point =
          Position.of([10.0, 20.0, 100.0]); // longitude, latitude, altitude

      // WGS84 to Mercator
      final mercatorPoint = convertCoordinates(
          wgs84Point, CoordinateSystem.wgs84, CoordinateSystem.mercator);

      // Mercator to WGS84 (should get back close to the original)
      final reconvertedPoint = convertCoordinates(
          mercatorPoint, CoordinateSystem.mercator, CoordinateSystem.wgs84);
    ...
    test('toWGS84 should preserve altitude', () {
      final mercatorPoint = Position.of(
          [1113194.9079327357, 2273030.92688923, 100.0]); // x, y, altitude
